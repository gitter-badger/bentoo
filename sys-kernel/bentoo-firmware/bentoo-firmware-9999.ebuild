...
KBUILD_OUTPUT="${SYSROOT}/var/cache/portage/sys-kernel/bentoo-kernel"
inherit linux-info
...
CDEPEND=">=sys-kernel/bentoo-modules-4.6.3-r1:="
DEPEND="${CDEPEND}
	sys-kernel/bentoo-sources"
RDEPEND="${CDEPEND}
...
# source name is linux-firmware, not bentoo-firmware
