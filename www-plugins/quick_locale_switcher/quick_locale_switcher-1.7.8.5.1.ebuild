...
HOMEPAGE="https://addons.mozilla.org/ru/firefox/addon/quick-locale-switcher/"
...
src_prepare(){
	epatch "${FILESDIR}/quick_locale_switcher-1.7.8.5.1-install.rdf.patch" || die 'epatch failed'
}
